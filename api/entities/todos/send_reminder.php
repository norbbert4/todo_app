...
require_once 'https://todoapp.norbbert4.hu/todo_app/vendor/autoload.php'; // Abszolút elérési út

// Adatbázis kapcsolat betöltése
require_once 'https://todoapp.norbbert4.hu/todo_app/api/modules/_db.php'; // Abszolút elérési út a helyes mappához (api/modules)
